...
Drawdowns reached around 12%, higher than anything seen so far in live. I do think the backtest is very optimistic for performance in 2022 and 2023, I think the combination of EDZ with tech did well for no real structural reason. I'd expect drawdowns closer to probably 30% over a sustained downtrend like that, but need to backtest with RWM.
